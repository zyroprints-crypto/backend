...
from app.modules.admin.repository import LoginEventRepository
...
class AuthService:
    ...
    def login_with_password(self, phone: str, password: str) -> TokenPair:
        ...
        self.login_events.record(user.id, method="password")
        return self._issue_tokens(user)
    ...
    def verify_otp_and_login(self, phone: str, otp: str) -> TokenPair:
        ...
        self.login_events.record(user.id, method="otp")
        return self._issue_tokens(user)
    ...
    def google_login(self, id_token: str) -> TokenPair:
        ...
        self.login_events.record(user.id, method="google")
        return self._issue_tokens(user)
